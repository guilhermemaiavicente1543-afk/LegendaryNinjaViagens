...
export default function App() {
  ...
  async function startCharacterTravel() {
    ...
    if (points.length !== 2) {
      alert("Clique em dois pontos no mapa: origem e destino.");
      return;
    }
    ...
    const newTravel = {
      ...
      startCoord: points[0],
      endCoord: points[1],
      startCenter: getSmallCellCenter(points[0]),
      endCenter: getSmallCellCenter(points[1]),
    ...
    if (isSupabaseConfigured && supabase && session?.user) {
      const payload = {
        ...
        end_coord: points[1],
        start_center: getSmallCellCenter(points[0]),
        end_center: getSmallCellCenter(points[1]),
