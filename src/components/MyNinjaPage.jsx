...
function buildPayload(form, userId) {
  return {
    ...
    village_or_organization: form.villageOrOrganization,
    ...
    if (!characterTravel || !location) {
      return (
        <div className="profile-tab-content">
          ...
          <p className="empty-message">
            Vá até o Mapa de Viagem, clique em origem e destino, selecione seu
            ninja e inicie uma viagem.
          </p>
        </div>
      );
    }

    const arrived = location.progress >= 1;
    ...
    return (
      <div className="profile-tab-content">
        <div className="skill-placeholder">
          ...
          <p>
            Esta será a área da teia de habilidades do seu ninja. Aqui vamos
            conectar estilos ninja, pré-requisitos e habilidades desbloqueadas.
          </p>

          <div className="mini-skill-tree">
            <span>Meu Estilo</span>
            <span>→</span>
            <span>{character.ninja_style || "Não definido"}</span>
            <span>→</span>
