...
const SHEET_SECTIONS = [
  ...
  },
  {
    id: "arsenal",
    icon: "武",
    title: "Arsenal e Contratos",
    description: "Itens, contratos, modo sábio, equipamentos especiais e recursos narrativos.",
    fields: [
      ["equipmentDetails", "Equipamentos detalhados"],
      ["contracts", "Contratos"],
  ...
  },
  {
    ...
    icon: "術",
    title: "Técnicas",
    description: "Registro de técnicas aprendidas, aprovadas, ensinadas, buscadas ou herdadas.",
    fields: [
...
const FIELD_HINTS = {
  ...
  equipmentDetails: "Detalhe local, origem, data de aquisição, missão, compra ou recompensa.",
  ...
  exclusiveTechniques: "Nome, rank, quem ensinou, data, narrador e ADM que aprovou.",
  physicalTechniques: "Ex.: CNP-1, Marik, 02/10/2024.",
  clanTechniques: "Técnicas derivadas de clã, parentesco ou linhagem.",
  neutralTechniques: "Técnicas sem elemento.",
  illusionTechniques: "Genjutsus e técnicas ilusórias.",
  elementalTechniques: "Técnicas elementares: Katon, Fūton, Raiton, Suiton, Doton etc.",
      ...
      <header className="full-sheet-header polished">
        <div>
          ...
          <span>
            ...
            provas, técnicas, status, ações ocultas, medicina, missões e desenvolvimento.
          </span>
        </div>
