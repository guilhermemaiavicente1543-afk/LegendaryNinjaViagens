...
<button
  ...
  function renderMobileNinjaBoard() {
    if (!character) return null;

    return (
      <div className="mobile-ninja-board-shell">
        <img
          className="mobile-ninja-board-bg"
          src="/mobile-boards/meu-ninja-mobile-board.webp"
          alt=""
          aria-hidden="true"
        />

        <div className="mobile-board-character-name">
          {character.character_name}
        </div>

        <div className="mobile-board-description">
        ...
        <button
          type="button"
          className="mobile-board-tab mobile-board-tab-profile"
        ...
        <button
          type="button"
          className="mobile-board-tab mobile-board-tab-location"
        ...
        <button
          type="button"
          className="mobile-board-tab mobile-board-tab-skills"
          onClick={() => setProfileTab("skills")}
        >
          Árvore
        </button>

        <div className="mobile-board-portrait">
        ...
        <button
          type="button"
          className="mobile-board-photo-button"
          onClick={() => {
            setForm(dbToForm(character));
            setIsEditing(true);
          }}
        ...
        <div className="mobile-board-epithet">
          {character.epithet || character.rank_title || "Ninja sem alcunha definida"}
        </div>

        <div className="mobile-board-badge mobile-board-village">
          {character.village_or_organization || "Sem aldeia"}
        </div>

        <div className="mobile-board-badge mobile-board-style">
          {character.ninja_style || "Sem estilo"}
        </div>

        <div className="mobile-board-badge mobile-board-rank">
          {character.rank_title || "Sem graduação"}
        </div>

        <div className="mobile-board-sheet-title">
          Ficha Complementar
        </div>

        <div className="mobile-board-sheet-desc">
        ...
        <div className="mobile-board-sheet-grid">
          <span>Registro de Provas</span>
          <span>Ciência e Medicina</span>
          <span>Contratos e Vínculos</span>
          <span>Inventário</span>
          <span>Atividades e Missões</span>
          <span>Status do Personagem</span>
          <span>APA Especial / Ações Ocultas</span>
          <span>Desenvolvimento Narrativo</span>
        </div>

        <div className="mobile-board-info-card mobile-board-identity">
          <strong>Identidade</strong>
          <span>Nome • Player • Gênero</span>
          <span>Idade • Aniversário • Altura/Peso</span>
        </div>

        <div className="mobile-board-info-card mobile-board-origin">
          <strong>Afiliação e origem</strong>
          <span>Aldeia ou Organização • Clã</span>
          <span>Kekkei Genkai • Pontos de habilidade</span>
        </div>

        <div className="mobile-board-info-card mobile-board-map-icon">
          <strong>Ícone do mapa</strong>
          <span>{character.icon_url ? "Personalizado" : "Nenhum ícone definido"}</span>
        </div>
      </div>
    );
  }
      ...
      {!character || isEditing ? (
        ...
        <div className="characters-layout">
          <section className={`character-profile-panel ${profileTab === "skills" ? "skill-tree-fullscreen" : ""}`}>
            ...
            {profileTab === "info" && (
              <>
                {renderMobileNinjaBoard()}

                <div className="my-ninja-unified-profile desktop-ninja-profile-layout">
                  {renderInfoTab()}
