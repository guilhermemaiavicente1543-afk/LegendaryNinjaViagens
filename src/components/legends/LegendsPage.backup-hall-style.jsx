            ...
            <div className="legend-card-grid">
              {season.legends.map((legend) => (
                <article
                  ...
                  className="legend-card legend-card-clickable"
                  role="button"
                  tabIndex={0}
                  onClick={() => setSelectedLegend({ ...legend, seasonTitle: season.title, seasonYears: season.years })}
                  onKeyDown={(event) => {
                    if (event.key === "Enter" || event.key === " ") {
                      event.preventDefault();
                      setSelectedLegend({ ...legend, seasonTitle: season.title, seasonYears: season.years });
                    }
                  }}
                >
      ...
      {selectedLegend && (
        ...
        >
          ...
          >
            ...
            <div className="legend-detail-seal">伝説</div>

            <p className="eyebrow">{selectedLegend.seasonTitle} · {selectedLegend.seasonYears}</p>
            ...
            <section>
              <h3>Próxima evolução da página</h3>
              <p>
                Podemos transformar este dossiê em uma página individual com linha do tempo,
                feitos principais, relações com vilas, organizações, guerras, Bijuus,
                prints autorizados e aparência protegida.
              </p>
            </section>
          </article>
        </div>
