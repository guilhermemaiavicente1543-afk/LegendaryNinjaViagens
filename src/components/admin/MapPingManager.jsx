    ...
    <section className="admin-map-pings">
      <div className="admin-card admin-card-wide">
        ...
        <form className="map-ping-form" onSubmit={handleSubmit}>
          ...
          <label>
            URL direta da imagem do painel
            <input
              type="url"
              inputMode="url"
              value={form.image_url}
              onChange={(event) => updateField("image_url", event.target.value)}
              placeholder="Ex: https://site.com/imagem-da-vila.png"
            />
            <small className="map-ping-field-hint">
              Use uma URL direta terminando em .png, .jpg, .jpeg, .webp ou .gif. Não use link de página.
            </small>
          </label>
