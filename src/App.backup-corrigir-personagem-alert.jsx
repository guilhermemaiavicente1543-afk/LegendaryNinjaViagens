...
export default function App() {
  ...
  async function startDimensionTeleport() {
    ...
    alert(`${selectedTravelCharacter.characterName || "<span className="ln-personagem-title-wrap"><img className="ln-personagem-title-icon" src="/icons/ln-personagem-ninja.svg" alt="" /> Personagem</span>"} entrou em: ${dimensionLabel}`);
  }
          ...
          {showMobileMapOptions && (
            <div className="mobile-map-quick-controls" aria-label="Controles rápidos do mapa">
              ...
              <div className="mobile-map-travel-tools">
                <h3>
                  <span className="ln-personagem-title-wrap"><img className="ln-personagem-title-icon" src="/icons/ln-personagem-ninja.svg" alt="" /> Personagem</span>
                </h3>
